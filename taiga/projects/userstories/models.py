...
from taiga.projects.time_spent.models import TimeSpentMixin
...
class UserStory(OCCModelMixin, WatchedModelMixin, BlockedMixin, TaggedMixin, DueDateMixin, TimeSpentMixin, models.Model):
